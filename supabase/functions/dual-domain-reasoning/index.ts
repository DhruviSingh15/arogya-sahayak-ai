...
serve(async (req) => {
  ...
  try {
    ...
    const medicalPrompt = language === 'hi' 
      ? `स्वास्थ्य विशेषज्ञ के रूप में "${query}" का चिकित्सा विश्लेषण करें। लक्षण, संभावित कारण, और सामान्य सलाह दें। महत्वपूर्ण: सरल, सीधी भाषा में लिखें। किसी भी विशेष प्रतीक (*, #, -) का उपयोग न करें। केवल सादा पाठ, संख्याएं और सामान्य विराम चिह्न का उपयोग करें। संक्षिप्त रहें, 3-4 वाक्यों में।`
      : `As a medical expert, analyze "${query}" from a health perspective. Provide symptoms analysis, potential causes, and general medical advice. IMPORTANT: Write in simple, straightforward language. Do NOT use any special symbols (*, #, -) for formatting. Use only plain text, numbers, and regular punctuation. Keep it SHORT, 3-4 sentences max.`;

    // Step 3: Legal reasoning pipeline  
    const legalPrompt = language === 'hi' 
      ? `कानूनी विशेषज्ञ के रूप में "${query}" में भारतीय कानून के तहत रोगी के अधिकार, संबंधित धाराएं, और कानूनी विकल्प बताएं। महत्वपूर्ण: सरल, सीधी भाषा में लिखें। किसी भी विशेष प्रतीक (*, #, -) का उपयोग न करें। केवल सादा पाठ, संख्याएं और सामान्य विराम चिह्न का उपयोग करें। संक्षिप्त रहें, 3-4 वाक्यों में।`
      : `As a legal expert, analyze "${query}" under Indian law to identify patient rights, relevant sections, and legal options available. IMPORTANT: Write in simple, straightforward language. Do NOT use any special symbols (*, #, -) for formatting. Use only plain text, numbers, and regular punctuation. Keep it SHORT, 3-4 sentences max.`;
...
संयुक्त सलाह दें जो दोनों क्षेत्रों को संतुलित करे। महत्वपूर्ण: सरल, सीधी भाषा में लिखें। किसी भी विशेष प्रतीक (*, #, -) का उपयोग न करें। केवल सादा पाठ, संख्याएं और सामान्य विराम चिह्न का उपयोग करें। बहुत संक्षिप्त रहें, अधिकतम 4-5 वाक्य।`
...
Give combined advice that balances both domains. IMPORTANT: Write in simple, straightforward language. Do NOT use any special symbols (*, #, -) for formatting. Use only plain text, numbers, and regular punctuation. Keep very SHORT, max 4-5 sentences.`;
